   ...
   <div class="panel panel-success">
    <div class="panel-heading">
        Java EE 6 Web Component Developer Certified Expert [BJCT-02]
    </div>
      <div class="panel-body">
<div class="row">
  <div class="col-lg-6">
    <div class="form-group">
      <label for="phone">Training Code:</label>
      BJCT-02
    </div>
  </div>
  <div class="col-lg-6">
...
<div class="row">
  <div class="col-lg-6">
    <div class="form-group">
      <label for="phone">Training Format:</label>
      Live Virtual Class
    </div>
  </div>
  <div class="col-lg-6">
...
<div class="row">
  <div class="col-lg-6">
    <div class="form-group">
      <label for="phone">Cource Materials:</label>
      English
    </div>
  </div>
  <div class="col-lg-6">
...
<div class="row">
  <div class="col-lg-12">
    <div class="form-group">
      <label for="phone">Pre-requisite:</label>
      Basic understanging programming.
    </div>
  </div>
 </div>
<div class="row">
  <div class="col-lg-12">
    <div class="form-group">
      ...
      After this training session you will be able to design/develop MVC based desktop application.<br>
      By using Java Standard Edition.
    </div>
  </div>
 </div>
 
<b><u>Training Contents:</u></b><br>				
<p>
<pre>
