...
<?php $galleryPath = (isset($_GET['event'])?$_GET['event']:'home');
 ?>


var mygallery=new simpleGallery({
	wrapperid: "simplegallery1", //ID of main gallery container,
	dimensions: [1545, 238], //width/height of gallery in pixels. Should reflect dimensions of the images exactly
	imagearray: [
		["galleries/<?php printf($galleryPath);?>/0.png", "http://www.bitguiders.com", "", ""],
		["galleries/<?php printf($galleryPath);?>/1.png", "http://www.bitguiders.com", "", ""],
		["galleries/<?php printf($galleryPath);?>/2.png", "http://www.bitguiders.com", "", ""],
		["galleries/<?php printf($galleryPath);?>/3.png", "http://www.bitguiders.com", "", ""]
	],
